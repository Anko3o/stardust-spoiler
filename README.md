...
目前测试自建前端没问题，kelivo，rikkahub等以后大概会更新吧……
...
||你想隐藏的内容||
用两条竖线包裹首尾即可，注意是英文||
理论上其他活动也可以随意隐藏，而非局限于聊天区域。（日记等等……）也许会更新。
...
- **安可（anko）** —— 点单人、首席验收官。「滑动的时候粒子不会跟着走」就是她抓到的，坑 ① 因她而修。
- **费洛（Feylor）** —— 切帧分析指出初版「有边缘感，Threads 是粒子散开不是模糊」，本仓库存在的直接原因。
